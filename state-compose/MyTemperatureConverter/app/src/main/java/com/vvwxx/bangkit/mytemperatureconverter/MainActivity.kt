package com.vvwxx.bangkit.mytemperatureconverter
...
import com.vvwxx.bangkit.mytemperatureconverter.ui.theme.MyTemperatureConverterTheme
...
fun StatelessTemperatureInput(
    input: String,
    output: String,
    onValueChange : (String) -> Unit, // untuk event sesuaikan dengan kebutuhan, kalau buttom onClick
    modifier: Modifier = Modifier,
) {
    Column(modifier.padding(16.dp)) {
        Text(
